...
#define __GMP_CFLAGS "-O2 -g -pedantic -fomit-frame-pointer -Wno-psabi -Wa,--noexecstack -ffunction-sections -funwind-tables -no-canonical-prefixes -fno-strict-aliasing -fstack-protector-strong -finline-limit=300 -funswitch-loops -fpic -Bdynamic -Wl,-dynamic-linker,/system/bin/linker -Wl,--gc-sections -Wl,-z,nocopyreloc -DANDROID -D__aarch64__ -march=armv8-a -mfpu=neon -I/Users/inchanji/github/AndroidStudioProjects/lib/toolchain/android-30-arm64/lib/gcc/aarch64-linux-android/4.9.x/libgcc.a"
