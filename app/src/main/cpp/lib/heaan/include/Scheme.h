...
public:
	...
	void init(string root_path, int r);
	void init(string root_path, string enckeyname, string mulkeyname,string conkkeyname,string rotkeyname);
